...
const bn: PartialLocaleType = {
  WIP: "এই ফিচারটি এখনও উন্নয়নের অধীনে...",
  Error: {
    Unauthorized: isApp
      ? `বর্তমানে প্রবেশাধিকার যাচাই করা হয়নি, দয়া করে [অ্যাপ কী প্রদান করুন](/#/settings)🔑 `
      : `বর্তমানে প্রবেশাধিকার যাচাই করা হয়নি, দয়া করে [অ্যাপ কী প্রদান করুন](/#/settings)🔑 `,
  },
  Auth: {
    Return: "ফিরে যান",
    Title: "অনুগ্রহ করে অ্যাপ কী প্রদান করুন🔑",
    Tips: "দয়া করে ইনপুট করুন",
    SubTips: "OpenAI API_KEY (সরকারি) / Google AI Studio API_KEY ব্যবহার করুন",
    Input: "<অ্যাপ কী>",
