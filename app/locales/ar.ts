...
const ar: PartialLocaleType = {
  WIP: "هذه الميزة قيد التطوير...",
  Error: {
    Unauthorized: isApp
      ? `لم يتم التحقق من صلاحية الوصول بعد، يرجى [تقديم مفتاح التطبيق](/#/settings)🔑 `
      : `لم يتم التحقق من صلاحية الوصول بعد، يرجى [تقديم مفتاح التطبيق](/#/settings)🔑 `,
  },
  Auth: {
    Return: "عودة",
    Title: "يرجى تقديم مفتاح التطبيق🔑",
    Tips: "يرجى الإدخال",
    SubTips: "استخدم OpenAI API_KEY (رسمي) / Google AI Studio API_KEY",
    Input: "<مفتاح التطبيق>",
    Confirm: "تأكيد",
    Later: "لاحقاً",
    TopTips:
      "أنت أجمل الصدف بالنسبة لي.",
  },
  ChatItem: {
