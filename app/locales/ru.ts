...
const ru: PartialLocaleType = {
  WIP: "Эта функция еще в разработке...",
  Error: {
    Unauthorized: isApp
      ? `Доступ не подтвержден. Пожалуйста, [предоставьте ключ приложения](/#/settings)🔑 `
      : `Доступ не подтвержден. Пожалуйста, [предоставьте ключ приложения](/#/settings)🔑 `,
  },
  Auth: {
    Return: "Назад",
    Title: "Пожалуйста, предоставьте ключ приложения🔑",
    Tips: "Пожалуйста, введите",
    SubTips: "Используйте OpenAI API_KEY (официальный) / Google AI Studio API_KEY",
    Input: "<ключ приложения>",
    Confirm: "Подтвердить",
    Later: "Позже",
    TopTips: "Ты — моя самая красивая случайность.",
  },
  ChatItem: {
